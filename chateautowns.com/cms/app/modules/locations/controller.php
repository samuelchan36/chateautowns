...
//			die("done");
	...
	$vSmart->addHeader(array("Order", "Name", "City", "Province"));
	$vSmart->addEditField("OrderID");
	$vSmart->addEditField("Name");
	$vSmart->addField("City");
	$vSmart->addField("Province");
	...
	$vSmart->mColsWidths = array("20px", "60px", "100px",  "40%", "25%", "25%", "60px");
