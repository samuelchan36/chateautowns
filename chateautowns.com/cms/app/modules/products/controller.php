...
class CProductAdmin extends CSectionAdmin{
	...
	var $mLabels = array("Products", "Product");
	var $mClass = "CProduct";
...
//			die("done");
	...
	$vSmart->addImageField("Photo", "100px");
	...
	$vSmart->addCompositeFilter("Content", "a.Name,  a.Summary, a.Description", "Search", 1, "input_search w400");
