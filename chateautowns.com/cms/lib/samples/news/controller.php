...
class CNewsAdmin extends CSectionAdmin{

	var $table = "news";
	var $actions = array("edit","clone", "delete");
	var $mItemsPerPage = 40;
	var $mLabels = array("News", "News");
	var $mClass = "CNews";
...
//			die("done");
	...
	$vSmart->addHeader(array("Image", "Title", "Date"));
	$vSmart->addImageField("Image", "100px");
	$vSmart->addEditField("Name");
	$vSmart->adddField("ArticleDate");
...
//	$vSmart->addExtraActions(new CHref(getLink() . "order", "Mass Sort"));
	...
	$vSmart->mColsWidths = array("20px", "60px",  "100px", "60%", "20%", "60px");
