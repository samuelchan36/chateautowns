...
class CProjectAdmin extends CSectionAdmin{

	var $table = "projects";
	var $actions = array("edit", "up", "down", "delete");
	var $mItemsPerPage = 40;
	var $mLabels = array("Projects", "Project");
	var $mClass = "CProject";
...
//			die("done");
	...
	$vSmart->addHeader(array("Image", "Name"));
	...
	$vSmart->addCompositeFilter("Content", "a.Name,  a.Description", "Search", 1, "input_search w400");
