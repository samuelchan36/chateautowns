...
class CCommunityResource extends CDBContent {
...
function displayEdit() {
		...
		$this->form->addElement(new CSelect("CommunityID", $this->mDatabase->getAll2("select ID, Name from communities"), array("label"=>"Icon", "class"=>"mandatory")));
