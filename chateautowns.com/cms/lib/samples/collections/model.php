...
class CCollection extends CDBContent {
...
function displayEdit() {
		...
		$input = new CSelect("CommunityID", $this->mDatabase->getAll2("select ID, Name from communities order by orderid"), array("label" => "Community", "class"=>"mandatory w300", "placeholder"=>"Please select")); $this->form->addElement($input);
