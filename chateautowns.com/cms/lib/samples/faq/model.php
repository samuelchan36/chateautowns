...
function displayEdit() {
		...
		$this->form->addElement(new CTextInput("Name", array("label"=>"Question", "class"=>"mandatory")));
		$this->form->addElement(new CRichTextArea("Summary", array("label"=>"Answer", "class"=>"mandatory", "rows" => 10)));
