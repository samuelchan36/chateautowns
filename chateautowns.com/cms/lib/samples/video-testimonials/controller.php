...
class CVideoTestimonialAdmin extends CSectionAdmin{

	var $table = "video_testimonials";
	var $actions = array("edit","delete");
	var $mItemsPerPage = 40;
	var $mLabels = array("Video Testimonials", "Video Testimonial");
	var $mClass = "CVideoTestimonial";
