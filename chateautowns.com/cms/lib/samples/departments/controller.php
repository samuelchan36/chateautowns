...
class CDepartmentAdmin extends CSectionAdmin{

	var $table = "departments";
	var $actions = array("edit", "up", "down", "delete");
	var $mItemsPerPage = 40;
	var $mLabels = array("Departments", "Department");
	var $mClass = "CDepartment";
  ...
  function display() {
	...
	$vSmart->addHeader(array("Order ID", "Name"));
...
//	$vSmart->addExtraActions(new CHref(getLink() . "export", "Export"));
	...
	$vSmart->mColsWidths = array("20px", "20px", "100px", "80%", "60px");
